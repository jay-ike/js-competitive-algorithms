...
describe("graph problems", function () {
  ...
  it("should return the tasks ordering to finish all tasks", function () {
    ...
    assert.deepEqual(schedulingOrderToFinishTasks(prerequisites), [0, 1, 2]);
    prerequisites = [
      [0, 1],
      [1, 2],
      [2, 0],
  ...
  it("should return all possible scheduling order given a list of tasks with prerequisites", function () {
    var prerequisites = [
      [0, 1],
      [1, 2],
    ];
  ...
  it("should return the character ordering of a dictionary given the words ordering", function () {
  ...
  it("should check reconstruct a sequence with an array of sequences", function () {
    ...
    assert.isTrue(
      canReconstructOriginalSequenceFromSequences(originalSequence, sequences)
    );
