...
describe("number converter tests", function () {
    ...
    describe("digit converter tests", function () {
        it("should print the value of 0 in words", function () {
            assert.equal(numberConverter.convertDigit(5), "five");
        });

        it("should print 60 exceed 1 digit", function () {
            assert.throws(
                () => numberConverter.convertDigit(60),
                Error,
                "60 exceed 1 digit"
            );
        });
    ...
    describe("tens converter test", function () {
        ...
        it(
            ...
            "of the number is greater than 2",
            function () {
                assert.throws(
                    () => numberConverter.convertTens(600),
                    Error,
                    "600 exceed 2 digits"
                );
            }
    ...
    describe("hundreds converter test", function () {
        it("should print the value of 154 in words", function () {
            assert.equal(
                numberConverter.convertHundreds(154),
        ...
        it("should print the value of 599 in words", function () {
            assert.equal(
                numberConverter.convertHundreds(599),
                "five hundreds and ninety nine"
            );
        });
        it(
            "should throw an error if the length " +
            ...
            function () {
                assert.throws(
                    () => numberConverter.convertHundreds(1600),
                    Error,
                    "1600 exceed 3 digits"
                );
            }
        );
    });
    ...
    describe("thousands converter test", function () {
        it("should print the value of 1551 in words", function () {
            assert.equal(
                numberConverter.convertThousands(1551),
                "one thousand five hundreds and fifty one"
            );
        });
        it("should print the value of 0 in words", function () {
        ...
        it("should print the value of 500700 in words", function () {
            assert.equal(
                numberConverter.convertThousands(500700),
                "five hundreds thousands seven hundreds"
            );
        });
        it("should print negative value as positive value", function () {
            assert.equal(
        ...
        it(
            ...
            function () {
                assert.throws(
                    () => numberConverter.convertThousands(1000600),
                    Error,
                    "1000600 exceed 6 digits"
                );
            }
        );
    });
    ...
    describe("million converter test", function () {
        it("should print the value of 1500005", function () {
            assert.equal(
                numberConverter.convertMillions(1500005),
                "one million five hundreds thousands five"
            );
        });
        it(
            "should throw an error if the length" +
            ...
            function () {
                assert.throws(
                    () => numberConverter.convertMillions(20_000_000_600),
                    Error,
                    "20000000600 exceed 9 digits"
                );
            }
        );
        it("should print the value of 0 in words", function () {
    ...
    describe("billion converter test", function () {
        it("should print the value of 5_500_000_687", function () {
            assert.equal(
                numberConverter.convertBillions(5_500_000_687),
                "five billions five hundreds millions " +
                "six hundreds and eighty seven"
            );
        });
        it(
            "should throw an error if the length " +
            ...
            function () {
                assert.throws(
                    () => numberConverter.convertBillions(50_000_500_800_600),
                    Error,
                    "50000500800600 exceed 12 digits"
                );
            }
        );
        it("should print the value of 0 in words", function () {
